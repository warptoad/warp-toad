<script lang="ts">
    ...
    import { connectObsidionWallet, disconnectObsidionWallet, isWalletConnected, aztecWalletStore } from '../../stores/walletStore';
  ...
  <div class="h-full flex flex-col gap-2">
    <div class="flex gap-2" class:text-success={isWalletConnected($aztecWalletStore)} class:text-error={!isWalletConnected($aztecWalletStore)}>
