...
export class WarpToadCoreContract extends ContractBase {
  ...
  public static get storage(): ContractStorageLayout<'maxTreeDepth' | 'localRoot' | 'lastLeafIndex' | 'leaves' | 'lastSubtrees' | 'zeroes'> {
      return {
        maxTreeDepth: {
      slot: new Fr(1n),
    },
...
zeroes: {
      ...
      } as ContractStorageLayout<'maxTreeDepth' | 'localRoot' | 'lastLeafIndex' | 'leaves' | 'lastSubtrees' | 'zeroes'>;
    }
