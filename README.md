...
#### deploy on aztec
```shell
PRIVATE_KEY=0xUprivateKey NATIVE_TOKEN_ADDRESS=0x4ed7c70F96B99c776995fB64377f0d4aB3B0e1C1 PXE_URL=http:/localhost:8080 yarn workspace @warp-toad/backend hardhat run scripts/deploy/deployAztec.ts --network aztecSandbox;
```
