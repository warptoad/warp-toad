...
const PRIVATE_KEY = config_js_1.vars.get("PRIVATE_KEY");
...
const ETHERSCAN_KEY = config_js_1.vars.get("ETHERSCAN_KEY");
const ETHERSCAN_KEY_SCROLL = config_js_1.vars.get("ETHERSCAN_KEY_SCROLL");
const config = {
    mocha: {
