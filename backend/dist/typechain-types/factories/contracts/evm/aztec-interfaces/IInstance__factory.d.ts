...
import type { IInstance, IInstanceInterface } from "../../../../contracts/evm/aztec-interfaces/IInstance";
export declare class IInstance__factory {
    ...
    static createInterface(): IInstanceInterface;
    static connect(address: string, runner?: ContractRunner | null): IInstance;
}
