...
export interface IGigaBridgeInterface extends Interface {
    getFunction(nameOrSignature: "getLocalRootProvidersIndex" | "isLocalRootProviders" | "sendGigaRoot" | "updateGigaRoot"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "ConstructedNewGigaRoot" | "ReceivedNewLocalRoot"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "sendGigaRoot", values: [AddressLike[], BigNumberish[]]): string;
...
export interface IGigaBridge extends BaseContract {
    connect(runner?: ContractRunner | null): IGigaBridge;
    waitForDeployment(): Promise<this>;
    interface: IGigaBridgeInterface;
    ...
    getFunction(nameOrSignature: "sendGigaRoot"): TypedContractMethod<[
        _gigaRootRecipients: AddressLike[],
        _amounts: BigNumberish[]
    ], [
        void
