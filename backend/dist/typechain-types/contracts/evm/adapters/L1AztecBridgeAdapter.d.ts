...
export interface L1AztecBridgeAdapterInterface extends Interface {
    getFunction(nameOrSignature: "getContentHash" | "getLocalRootAndBlock" | "getNewRootFromL2" | "gigaBridge" | "inbox" | "initialize" | "l2AztecBridgeAdapter" | "mostRecentL2Root" | "mostRecentL2RootBlockNumber" | "outbox" | "receiveGigaRoot" | "rollup" | "rollupVersion"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "NewGigaRootSentToAztec" | "ReceivedNewL2Root"): EventFragment;
    encodeFunctionData(functionFragment: "getContentHash", values: [BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "getLocalRootAndBlock", values?: undefined): string;
    encodeFunctionData(functionFragment: "getNewRootFromL2", values: [BytesLike, BigNumberish, BigNumberish, BigNumberish, BytesLike[]]): string;
    encodeFunctionData(functionFragment: "gigaBridge", values?: undefined): string;
    encodeFunctionData(functionFragment: "inbox", values?: undefined): string;
    encodeFunctionData(functionFragment: "initialize", values: [AddressLike, BytesLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "l2AztecBridgeAdapter", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "rollupVersion", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "l2AztecBridgeAdapter", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "rollupVersion", data: BytesLike): Result;
}
export declare namespace NewGigaRootSentToAztecEvent {
    type InputTuple = [
        newGigaRoot: BytesLike,
        key: BytesLike,
        index: BigNumberish
    ];
    type OutputTuple = [newGigaRoot: string, key: string, index: bigint];
...
export interface L1AztecBridgeAdapter extends BaseContract {
    ...
    getFunction(nameOrSignature: "inbox"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "l2AztecBridgeAdapter"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "outbox"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "receiveGigaRoot"): TypedContractMethod<[_newGigaRoot: BigNumberish], [void], "payable">;
    getFunction(nameOrSignature: "rollup"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "rollupVersion"): TypedContractMethod<[], [bigint], "view">;
    getEvent(key: "NewGigaRootSentToAztec"): TypedContractEvent<NewGigaRootSentToAztecEvent.InputTuple, NewGigaRootSentToAztecEvent.OutputTuple, NewGigaRootSentToAztecEvent.OutputObject>;
    ...
    filters: {
        "NewGigaRootSentToAztec(bytes32,bytes32,uint256)": TypedContractEvent<NewGigaRootSentToAztecEvent.InputTuple, NewGigaRootSentToAztecEvent.OutputTuple, NewGigaRootSentToAztecEvent.OutputObject>;
        NewGigaRootSentToAztec: TypedContractEvent<NewGigaRootSentToAztecEvent.InputTuple, NewGigaRootSentToAztecEvent.OutputTuple, NewGigaRootSentToAztecEvent.OutputObject>;
