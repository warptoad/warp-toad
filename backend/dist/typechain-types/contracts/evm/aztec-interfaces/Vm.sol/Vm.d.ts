...
export declare namespace VmSafe {
    ...
    type AccessListItemStructOutput = [
        target: string,
        storageKeys: string[]
    ] & {
        target: string;
...
export interface VmInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "coolSlot", values: [AddressLike, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "deployCode(string,uint256,bytes32)", values: [string, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "deployCode(string,bytes,bytes32)", values: [string, BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "deployCode(string,uint256)", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "deployCode(string,bytes32)", values: [string, BytesLike]): string;
    encodeFunctionData(functionFragment: "deployCode(string,bytes)", values: [string, BytesLike]): string;
    encodeFunctionData(functionFragment: "deployCode(string,bytes,uint256,bytes32)", values: [string, BytesLike, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "deployCode(string)", values: [string]): string;
    encodeFunctionData(functionFragment: "deployCode(string,bytes,uint256)", values: [string, BytesLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "expectCreate", values: [BytesLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "expectCreate2", values: [BytesLike, AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "setArbitraryStorage(address,bool)", values: [AddressLike, boolean]): string;
    encodeFunctionData(functionFragment: "setArbitraryStorage(address)", values: [AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "shuffle", values: [BigNumberish[]]): string;
    ...
    encodeFunctionData(functionFragment: "signAndAttachDelegation(address,uint256)", values: [AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "signAndAttachDelegation(address,uint256,uint64)", values: [AddressLike, BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "signDelegation(address,uint256)", values: [AddressLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "signDelegation(address,uint256,uint64)", values: [AddressLike, BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "sort", values: [BigNumberish[]]): string;
    ...
    encodeFunctionData(functionFragment: "warmSlot", values: [AddressLike, BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "deployCode(string,uint256,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deployCode(string,bytes,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deployCode(string,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deployCode(string,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deployCode(string,bytes)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deployCode(string,bytes,uint256,bytes32)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deployCode(string)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deployCode(string,bytes,uint256)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setArbitraryStorage(address,bool)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setArbitraryStorage(address)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "signAndAttachDelegation(address,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "signAndAttachDelegation(address,uint256,uint64)", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "signDelegation(address,uint256)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "signDelegation(address,uint256,uint64)", data: BytesLike): Result;
...
export interface Vm extends BaseContract {
    ...
    getFunction(nameOrSignature: "accessList"): TypedContractMethod<[
        access: VmSafe.AccessListItemStruct[]
    ], [
        void
    ], "nonpayable">;
    ...
    getFunction(nameOrSignature: "cool"): TypedContractMethod<[target: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "coolSlot"): TypedContractMethod<[
        target: AddressLike,
        slot: BytesLike
    ], [
        void
    ...
    getFunction(nameOrSignature: "deployCode(string,uint256,bytes32)"): TypedContractMethod<[
        artifactPath: string,
        value: BigNumberish,
        salt: BytesLike
    ], [
    ...
    getFunction(nameOrSignature: "deployCode(string,bytes,bytes32)"): TypedContractMethod<[
        artifactPath: string,
        constructorArgs: BytesLike,
        salt: BytesLike
    ], [
    ...
    getFunction(nameOrSignature: "deployCode(string,uint256)"): TypedContractMethod<[
        artifactPath: string,
        value: BigNumberish
    ], [
        string
    ], "nonpayable">;
    getFunction(nameOrSignature: "deployCode(string,bytes32)"): TypedContractMethod<[
        artifactPath: string,
        salt: BytesLike
    ], [
        string
    ...
    getFunction(nameOrSignature: "deployCode(string,bytes,uint256,bytes32)"): TypedContractMethod<[
        artifactPath: string,
        constructorArgs: BytesLike,
        value: BigNumberish,
        salt: BytesLike
    ...
    getFunction(nameOrSignature: "deployCode(string,bytes,uint256)"): TypedContractMethod<[
        artifactPath: string,
        constructorArgs: BytesLike,
        value: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "expectCreate"): TypedContractMethod<[
        bytecode: BytesLike,
        deployer: AddressLike
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "expectCreate2"): TypedContractMethod<[
        bytecode: BytesLike,
        deployer: AddressLike
    ], [
        void
    ...
    getFunction(nameOrSignature: "foundryVersionAtLeast"): TypedContractMethod<[version: string], [boolean], "view">;
    getFunction(nameOrSignature: "foundryVersionCmp"): TypedContractMethod<[version: string], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "noAccessList"): TypedContractMethod<[], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "setArbitraryStorage(address,bool)"): TypedContractMethod<[
        target: AddressLike,
        overwrite: boolean
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "setArbitraryStorage(address)"): TypedContractMethod<[target: AddressLike], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "shuffle"): TypedContractMethod<[array: BigNumberish[]], [bigint[]], "nonpayable">;
    ...
    getFunction(nameOrSignature: "signAndAttachDelegation(address,uint256)"): TypedContractMethod<[
        implementation: AddressLike,
        privateKey: BigNumberish
    ], [
        VmSafe.SignedDelegationStructOutput
    ], "nonpayable">;
    getFunction(nameOrSignature: "signAndAttachDelegation(address,uint256,uint64)"): TypedContractMethod<[
        implementation: AddressLike,
        privateKey: BigNumberish,
        nonce: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "signDelegation(address,uint256)"): TypedContractMethod<[
        implementation: AddressLike,
        privateKey: BigNumberish
    ], [
        VmSafe.SignedDelegationStructOutput
    ], "nonpayable">;
    getFunction(nameOrSignature: "signDelegation(address,uint256,uint64)"): TypedContractMethod<[
        implementation: AddressLike,
        privateKey: BigNumberish,
        nonce: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "sort"): TypedContractMethod<[array: BigNumberish[]], [bigint[]], "nonpayable">;
    ...
    getFunction(nameOrSignature: "warmSlot"): TypedContractMethod<[
        target: AddressLike,
        slot: BytesLike
    ], [
        void
