...
export interface IMintableERC20Interface extends Interface {
    getFunction(nameOrSignature: "addMinter" | "allowance" | "approve" | "balanceOf" | "mint" | "removeMinter" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
export interface IMintableERC20 extends BaseContract {
    ...
    getFunction(nameOrSignature: "addMinter"): TypedContractMethod<[_minter: AddressLike], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "removeMinter"): TypedContractMethod<[_minter: AddressLike], [void], "nonpayable">;
