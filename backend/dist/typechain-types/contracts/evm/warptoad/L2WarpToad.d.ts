...
export interface L2WarpToadInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "bridgeRoot", values?: undefined): string;
...
export interface L2WarpToad extends BaseContract {
    ...
    getFunction(nameOrSignature: "bridgeRoot"): TypedContractMethod<[], [void], "view">;
