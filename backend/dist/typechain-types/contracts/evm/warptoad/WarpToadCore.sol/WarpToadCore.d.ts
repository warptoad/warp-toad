...
export interface WarpToadCoreInterface extends Interface {
...
export interface WarpToadCore extends BaseContract {
    connect(runner?: ContractRunner | null): WarpToadCore;
    waitForDeployment(): Promise<this>;
    interface: WarpToadCoreInterface;
