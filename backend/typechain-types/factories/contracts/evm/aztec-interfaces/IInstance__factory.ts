...
import type {
  IInstance,
  IInstanceInterface,
} from "../../../../contracts/evm/aztec-interfaces/IInstance";
...
export class IInstance__factory {
  static readonly abi = _abi;
  static createInterface(): IInstanceInterface {
    return new Interface(_abi) as IInstanceInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IInstance {
    return new Contract(address, _abi, runner) as unknown as IInstance;
  }
}
