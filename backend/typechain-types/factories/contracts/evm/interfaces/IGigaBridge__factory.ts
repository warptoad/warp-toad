...
import type {
  IGigaBridge,
  IGigaBridgeInterface,
} from "../../../../contracts/evm/interfaces/IGigaBridge";
...
export class IGigaBridge__factory {
  ...
  static createInterface(): IGigaBridgeInterface {
    return new Interface(_abi) as IGigaBridgeInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IGigaBridge {
    return new Contract(address, _abi, runner) as unknown as IGigaBridge;
  }
}
