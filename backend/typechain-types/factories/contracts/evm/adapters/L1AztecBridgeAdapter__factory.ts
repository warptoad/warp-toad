...
import type {
  ...
  L1AztecBridgeAdapterInterface,
} from "../../../../contracts/evm/adapters/L1AztecBridgeAdapter";
...
type L1AztecBridgeAdapterConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: L1AztecBridgeAdapterConstructorParams
...
export class L1AztecBridgeAdapter__factory extends ContractFactory {
  ...
  ): L1AztecBridgeAdapter__factory {
    return super.connect(runner) as L1AztecBridgeAdapter__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): L1AztecBridgeAdapterInterface {
    return new Interface(_abi) as L1AztecBridgeAdapterInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as L1AztecBridgeAdapter;
  }
}
