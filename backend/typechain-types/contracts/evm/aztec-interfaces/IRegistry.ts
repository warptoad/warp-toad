...
export interface IRegistryInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "GovernanceUpdated" | "InstanceAdded"
  ): EventFragment;

  encodeFunctionData(
    functionFragment: "addRollup",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "getCanonicalRollup",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "numberOfVersions",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace InstanceAddedEvent {
  export type InputTuple = [instance: AddressLike, version: BigNumberish];
  export type OutputTuple = [instance: string, version: bigint];
  export interface OutputObject {
    instance: string;
    version: bigint;
  }
...
export interface IRegistry extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "addRollup"
  ): TypedContractMethod<[_rollup: AddressLike], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "getCanonicalRollup"
  ...
  getFunction(
    nameOrSignature: "numberOfVersions"
  ...
  getEvent(
    ...
    InstanceAddedEvent.InputTuple,
    InstanceAddedEvent.OutputTuple,
    InstanceAddedEvent.OutputObject
  >;
  ...
  filters: {
    ...
    "InstanceAdded(address,uint256)": TypedContractEvent<
      InstanceAddedEvent.InputTuple,
      InstanceAddedEvent.OutputTuple,
      InstanceAddedEvent.OutputObject
    >;
    InstanceAdded: TypedContractEvent<
      InstanceAddedEvent.InputTuple,
      InstanceAddedEvent.OutputTuple,
      InstanceAddedEvent.OutputObject
    >;
