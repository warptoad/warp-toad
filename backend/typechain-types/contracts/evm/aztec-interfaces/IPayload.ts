...
export declare namespace IPayload {
  export type ActionStruct = { target: AddressLike; data: BytesLike };

  export type ActionStructOutput = [target: string, data: string] & {
    target: string;
    data: string;
  };
}
...
export interface IPayload extends BaseContract {
  ...
  ): TypedContractMethod<[], [IPayload.ActionStructOutput[]], "view">;
