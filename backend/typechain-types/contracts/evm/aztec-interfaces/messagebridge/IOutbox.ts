...
export declare namespace DataStructures {
  ...
  export type L1ActorStruct = { actor: AddressLike; chainId: BigNumberish };

  export type L1ActorStructOutput = [actor: string, chainId: bigint] & {
    actor: string;
    chainId: bigint;
  };

  export type L2ToL1MsgStruct = {
    sender: DataStructures.L2ActorStruct;
    recipient: DataStructures.L1ActorStruct;
    content: BytesLike;
  };

  export type L2ToL1MsgStructOutput = [
...
export interface IOutboxInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "MessageConsumed" | "RootAdded"
  ): EventFragment;
  ...
  encodeFunctionData(
    functionFragment: "getRootData",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "hasMessageBeenConsumedAtBlockAndIndex",
...
export namespace MessageConsumedEvent {
...
export namespace RootAddedEvent {
  export type InputTuple = [
    l2BlockNumber: BigNumberish,
    root: BytesLike,
...
export interface IOutbox extends BaseContract {
  ...
  getRootData: TypedContractMethod<
    [_l2BlockNumber: BigNumberish],
    [[string, bigint] & { root: string; minHeight: bigint }],
    "view"
  >;

  hasMessageBeenConsumedAtBlockAndIndex: TypedContractMethod<
    [_l2BlockNumber: BigNumberish, _leafIndex: BigNumberish],
    [boolean],
    "view"
  >;

  insert: TypedContractMethod<
    [_l2BlockNumber: BigNumberish, _root: BytesLike, _minHeight: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "hasMessageBeenConsumedAtBlockAndIndex"
  ): TypedContractMethod<
    [_l2BlockNumber: BigNumberish, _leafIndex: BigNumberish],
    [boolean],
    "view"
  ...
  getEvent(
    ...
    MessageConsumedEvent.InputTuple,
    MessageConsumedEvent.OutputTuple,
    MessageConsumedEvent.OutputObject
  >;
  getEvent(
    key: "RootAdded"
  ): TypedContractEvent<
    RootAddedEvent.InputTuple,
    RootAddedEvent.OutputTuple,
    RootAddedEvent.OutputObject
  >;

  filters: {
    "MessageConsumed(uint256,bytes32,bytes32,uint256)": TypedContractEvent<
      MessageConsumedEvent.InputTuple,
      MessageConsumedEvent.OutputTuple,
      MessageConsumedEvent.OutputObject
    >;
    MessageConsumed: TypedContractEvent<
      MessageConsumedEvent.InputTuple,
      MessageConsumedEvent.OutputTuple,
      MessageConsumedEvent.OutputObject
    >;

    "RootAdded(uint256,bytes32,uint256)": TypedContractEvent<
      RootAddedEvent.InputTuple,
      RootAddedEvent.OutputTuple,
      RootAddedEvent.OutputObject
    >;
    RootAdded: TypedContractEvent<
      RootAddedEvent.InputTuple,
      RootAddedEvent.OutputTuple,
      RootAddedEvent.OutputObject
    >;
