...
export interface L1ScrollBridgeAdapterInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "receiveGigaRoot(uint256,uint256)"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "l2ScrollBridgeAdapter",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "receiveGigaRoot(uint256)",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "receiveGigaRoot(uint256,uint256)",
    values: [BigNumberish, BigNumberish]
  ): string;
...
export interface L1ScrollBridgeAdapter extends BaseContract {
  ...
  getNewRootFromL2: TypedContractMethod<
    [_l2Root: BigNumberish, _l2BlockNumber: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  initialize: TypedContractMethod<
    [_l2ScrollBridgeAdapter: AddressLike, _gigaRootBridge: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  "receiveGigaRoot(uint256,uint256)": TypedContractMethod<
    [_newGigaRoot: BigNumberish, _gasLimit: BigNumberish],
    [void],
    "payable"
  >;
  ...
  getFunction(
    nameOrSignature: "l2ScrollBridgeAdapter"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "receiveGigaRoot(uint256)"
  ): TypedContractMethod<[_newGigaRoot: BigNumberish], [void], "payable">;
  getFunction(
    nameOrSignature: "receiveGigaRoot(uint256,uint256)"
  ): TypedContractMethod<
    [_newGigaRoot: BigNumberish, _gasLimit: BigNumberish],
    [void],
    "payable"
