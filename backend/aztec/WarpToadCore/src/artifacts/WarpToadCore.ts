...
export class WarpToadCoreContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, native_token: EthAddressLike, _name: string, _symbol: string, _decimals: (bigint | number)) {
    return new DeployMethod<WarpToadCoreContract>(PublicKeys.default(), wallet, WarpToadCoreContractArtifact, (instance, wallet) => WarpToadCoreContract.at(instance.address, wallet), Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, native_token: EthAddressLike, _name: string, _symbol: string, _decimals: (bigint | number)) {
    return new DeployMethod<WarpToadCoreContract>(publicKeys, wallet, WarpToadCoreContractArtifact, (instance, wallet) => WarpToadCoreContract.at(instance.address, wallet), Array.from(arguments).slice(2));
  }
  ...
  public static deployWithOpts<M extends keyof WarpToadCoreContract['methods']>(
    ...
    return new DeployMethod<WarpToadCoreContract>(
      ...
      (instance, wallet) => WarpToadCoreContract.at(instance.address, wallet),
