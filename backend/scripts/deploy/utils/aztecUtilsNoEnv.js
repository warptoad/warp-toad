...
export async function initPXE(node, chainId) {
...
export async function setupWallet(node) {
    const wallet = await TestWallet.create(node);
    return wallet;
}
export async function getAztecTestAccounts(aztecNode) {
...
export async function initNodeClientNoEnv(nodeUrl) {
    try {
...
export async function getAztecTestAccountNoEnv(chainId, nodeUrl) {
...
export async function getContractInstanceFromAddressNoEnv(address, nodeUrl) {
...
//# sourceMappingURL=aztecUtilsNoEnv.js.map