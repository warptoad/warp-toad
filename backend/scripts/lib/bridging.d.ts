...
export declare function bridgeEVMLocalRootToL1(L2Adapter: L2ScrollBridgeAdapter, signer: ethers.Signer, confirmations?: number): Promise<ethers.TransactionReceipt>;
/**
 ...
 * @returns
 */
export declare function bridgeAZTECLocalRootToL1(aztecNode: AztecNode, L2AztecBridgeAdapter: L2AztecBridgeAdapterContract, L1AztecBridgeAdapter: L1AztecBridgeAdapter, provider: ethers.Provider, aztecWallet: AztecWallet, sponsoredPaymentMethod?: SponsoredFeePaymentMethod | undefined, confirmations?: number): Promise<{
    refreshRootTx: ethers.ContractTransactionReceipt;
    sendRootToL1Tx: import("@aztec/foundation/types").FieldsOf<import("@aztec/stdlib/tx").TxReceipt>;
    PXE_L2Root: Fr;
}>;
export declare function bridgeLocalRootToL1(l1Wallet: ethers.Signer, gigaBridge: GigaBridge, L1Adapter: L1Adapter, L2Adapter: L2Adapter, isAztec?: boolean, aztecNode?: AztecNode, sponsoredPaymentMethodAZTEC?: SponsoredFeePaymentMethod, aztecWallet?: AztecWallet, confirmations?: number): Promise<{
    sendRootToL1Tx: import("@aztec/foundation/types").FieldsOf<import("@aztec/stdlib/tx").TxReceipt>;
    sendRootToL1TxHash: import("@aztec/stdlib/tx").TxHash;
} | {
 ...
 * @returns
 */
export declare function updateGigaRoot(gigaBridge: GigaBridge, localRootProviders: ethers.AddressLike[], confirmations?: number): Promise<{
 ...
 * @returns
 */
export declare function sendGigaRoot(gigaBridge: GigaBridge, gigaRootRecipients: ethers.AddressLike[], allPayableGigaRootRecipients: ethers.AddressLike[], confirmations?: number): Promise<{
...
aztecNode: AztecNode, isSandBox?: boolean, sponsoredPaymentMethod?: SponsoredFeePaymentMethod | undefined, aztecWallet?: AztecWallet): Promise<{
    receiveGigaRootTx: import("@aztec/foundation/types").FieldsOf<import("@aztec/stdlib/tx").TxReceipt>;
}>;
export declare function waitForBlocksAztec(blocksToWait: number, aztecNode: AztecNode, isSandBox?: boolean, L2AztecBridgeAdapter?: L2AztecBridgeAdapterContract, aztecWallet?: AztecWallet): Promise<void>;
...
export declare function receiveGigaRootOnL2(L1Adapter: L1Adapter, L2Adapter: L2Adapter, L2WarpToad: L2WarpToad, sendGigaRootTx: ethers.TransactionReceipt, gigaRootSent?: bigint, isAztec?: boolean, aztecWallet?: AztecWallet, isSandBox?: boolean, aztecNode?: AztecNode, sponsoredPaymentMethod?: SponsoredFeePaymentMethod): Promise<{
    receiveGigaRootTx: import("@aztec/foundation/types").FieldsOf<import("@aztec/stdlib/tx").TxReceipt>;
    ...
    receiveGigaRootTx: undefined;
    receiveGigaRootTxHash: undefined;
    gigaRootOnL2: bigint | undefined;
}>;
...
export declare function bridgeBetweenL1AndL2(l1Wallet: ethers.Signer, L1Adapter: L1Adapter, gigaBridge: GigaBridge, L2Adapter: L2Adapter, L2WarpToad: L2WarpToad, localRootProviders: ethers.AddressLike[], payableLocalRootProviders: ethers.AddressLike[], aztecInputs?: {
    ...
    txObjects: {
        sendRootToL1Tx: ethers.TransactionReceipt | import("@aztec/foundation/types").FieldsOf<import("@aztec/stdlib/tx").TxReceipt>;
        gigaRootUpdateTx: ethers.ContractTransactionReceipt;
        sendGigaRootTx: ethers.ContractTransactionReceipt;
        receiveGigaRootTx: ethers.TransactionResponse | import("@aztec/foundation/types").FieldsOf<import("@aztec/stdlib/tx").TxReceipt> | undefined;
    };
    txHashes: {
        sendRootToL1TxHash: string | import("@aztec/stdlib/tx").TxHash;
        gigaRootUpdateTxHash: string;
        sendGigaRootTxHash: string;
        receiveGigaRootTxHash: string | Fr | undefined;
    };
    roots: {
        gigaRootSent: any;
    };
}>;
//# sourceMappingURL=bridging.d.ts.map