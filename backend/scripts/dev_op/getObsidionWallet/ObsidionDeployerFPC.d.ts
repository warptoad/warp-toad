import { AztecAddress, type AztecAddressLike, type ContractArtifact, ContractBase, ContractFunctionInteraction, type ContractMethod, type ContractStorageLayout, type ContractNotes, type FieldLike, type FunctionSelectorLike, PublicKeys, type Wallet } from '@aztec/aztec.js';
...
export declare class ObsidionDeployerFPCContract extends ContractBase {
     ...
     */
    static deploy(wallet: Wallet, signing_pub_key_x: FieldLike, signing_pub_key_y: FieldLike): any;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified public keys hash to derive the address.
     */
    static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, signing_pub_key_x: FieldLike, signing_pub_key_y: FieldLike): any;
    /**
    ...
    static deployWithOpts<M extends keyof ObsidionDeployerFPCContract['methods']>(opts: {
        ...
        method?: M;
        wallet: Wallet;
    }, ...args: Parameters<ObsidionDeployerFPCContract['methods'][M]>): any;
    /**
...
//# sourceMappingURL=ObsidionDeployerFPC.d.ts.map