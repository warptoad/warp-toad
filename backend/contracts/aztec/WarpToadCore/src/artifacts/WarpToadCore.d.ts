...
import { type AbiType, type AztecAddressLike, type ContractArtifact, EventSelector, type EthAddressLike, type FieldLike } from '@aztec/aztec.js/abi';
...
export declare class WarpToadCoreContract extends ContractBase {
    ...
    static get storage(): ContractStorageLayout<'giga_root' | 'native_token' | 'commitments' | 'balances' | 'allowances' | 'symbol' | 'name' | 'decimals' | 'deployer' | 'giga_root_provider' | 'l1_bridge_adapter'>;
...
//# sourceMappingURL=WarpToadCore.d.ts.map