...
import { calculateFeeFactor, createProof, generateNoirTest, getAztecNoteHashTreeRoot, getProofInputs } from "../scripts/lib/proving"//"warp-toad-old-backend/scripts/lib/proving" //warp-toad-old-backend";//"../scripts/lib/proving";
