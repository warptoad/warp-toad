...
//misc
import os from 'os';
import { WithdrawVerifier__factory } from "../typechain-types"; //"@warp-toad/backend/ethers/typechain-types"//"../typechain-types";
...
import { hashPreCommitment } from "../scripts/lib/hashing"; //"@warp-toad/backend/hashing";
import { calculateFeeFactor, createProof, getProofInputs } from "../scripts/lib/proving"; //"@warp-toad/backend/proving";
import { sendGigaRoot } from "../scripts/lib/bridging"; //"@warp-toad/backend/bridging";
...
describe("AztecWarpToad", function () {
    ...
    async function deploy() {
        ...
        // L1 GIGA!!!
        const gigaRootRecipients = [L1WarpToad.target];
        ...
        return { gigaBridge, L1WarpToad: L1WarpToad, nativeToken, LazyIMTLib, PoseidonT3Lib, evmWallets };
    }
...
//# sourceMappingURL=testL1ToL1.js.map